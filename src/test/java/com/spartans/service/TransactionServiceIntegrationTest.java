...
import com.spartans.service.TransactionServiceImpl;
...
public class TransactionServiceIntegrationTest {
    ...
    @Test
    void testBorrowBook() {
        Transaction transaction = transactionService.borrowBook(testUser.getUserId(), testBook.getBookId());
    ...
    @Test
    void testReturnBook() {
        Transaction borrowed = transactionService.borrowBook(testUser.getUserId(), testBook.getBookId());
        BorrowedBookDTO returned = transactionService.returnBook(testUser.getUserId(), testBook.getBookId());
    ...
    void testGetBorrowedBooks() {
        ...
        assertThat(borrowedBooks.get(0).getTransactionStatus()).isEqualTo(transactionStatusConfig.getBorrowed());
    }
