...
class AuthServiceTest {
    ...
    void changePassword_newPasswordsMismatch_throwsIllegalArgumentException() {
        try (MockedStatic<UserContext> mockedUserContext = mockStatic(UserContext.class)) {
            ...
            PasswordRequestDTO request = new PasswordRequestDTO("OldPass1!", "NewPass2@", "MismatchNewPass!");
    ...
    void changePassword_oldPasswordIncorrect_throwsInvalidLoginException() {
        try (MockedStatic<UserContext> mockedUserContext = mockStatic(UserContext.class)) {
            ...
            PasswordRequestDTO request = new PasswordRequestDTO("WrongOldPass!", "NewPass2@", "NewPass2@");
