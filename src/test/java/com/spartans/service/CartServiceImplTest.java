...
import static org.junit.jupiter.api.Assertions.*;
 ...
 public class CartServiceImplTest {
    ...
    void addBookToCart_PositiveCase() {
        ...
        when(mapper.toCartDto(any(Cart.class))).thenReturn(new CartDTO(10L, 1L, "The Alchemist", "Paulo Coelho", "Fiction", "978-0061122415","https://example.com/images/alchemist.jpg"));
    ...
    void addBookToCart_NegativeCase_UserNotFound() {
        ...
        RuntimeException ex = assertThrows(RuntimeException.class,
                () -> cartService.addBookToCart(99L, 2L));
