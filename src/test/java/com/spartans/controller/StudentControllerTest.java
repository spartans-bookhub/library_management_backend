...
public class StudentControllerTest {
    ...
    void testBorrowBook() throws Exception {
        when(studentService.borrowBook(anyLong(), anyLong())).thenReturn(transaction);
    ...
    void testReturnBook() throws Exception {
        when(studentService.returnBook(anyLong(), anyLong())).thenReturn(transaction);
    ...
    void testGetBorrowedBooks() throws Exception {
        when(studentService.getBorrowedBooks(anyLong())).thenReturn(List.of(transaction));
    ...
    void testGetOverdueBooks() throws Exception {
        when(studentService.getOverdueBooks(anyLong())).thenReturn(List.of(transaction));
    ...
    void testGetBorrowingHistory() throws Exception {
        when(studentService.getBorrowingHistory(anyLong())).thenReturn(List.of(transaction));
    ...
    void testCanBorrowMoreBooks() throws Exception {
        when(studentService.canBorrowMoreBooks(anyLong())).thenReturn(true);
    ...
    void testGetAvailableBooks() throws Exception {
        when(studentService.getAvailableBooks()).thenReturn(List.of(book));
    ...
    void testIsBookAvailable() throws Exception {
        when(studentService.isBookAvailable(anyLong())).thenReturn(true);
