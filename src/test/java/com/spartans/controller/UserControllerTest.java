...
public class UserControllerTest {
  ...
  void testBorrowBook() throws Exception {
    ...
    mockMvc
        .perform(post("/api/students/10/borrow/100"))
  ...
  void testReturnBook() throws Exception {
    ...
    mockMvc
        .perform(post("/api/students/10/return/100"))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.transactionId").value(1L));
  }
  ...
  void testGetBorrowedBooks() throws Exception {
    ...
    mockMvc
        .perform(get("/api/students/10/borrowed"))
        .andExpect(status().isOk())
  ...
  void testGetOverdueBooks() throws Exception {
    ...
    mockMvc
        .perform(get("/api/students/10/overdue"))
        .andExpect(status().isOk())
  ...
  void testGetBorrowingHistory() throws Exception {
    ...
    mockMvc
        .perform(get("/api/students/10/borrowing-history"))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$[0].bookId").value(100L));
  }
  ...
  void testCanBorrowMoreBooks() throws Exception {
    ...
    mockMvc
        .perform(get("/api/students/10/can-borrow"))
        .andExpect(status().isOk())
  ...
  void testGetAvailableBooks() throws Exception {
    ...
    mockMvc
        .perform(get("/api/students/books/available"))
        .andExpect(status().isOk())
  ...
  void testIsBookAvailable() throws Exception {
    ...
    mockMvc
        .perform(get("/api/students/books/100/availability"))
        .andExpect(status().isOk())
        .andExpect(content().string("true"));
  }
}
