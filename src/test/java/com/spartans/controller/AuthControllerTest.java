...
public class AuthControllerTest {
  ...
  void setUp() {
    ...
    mockMvc =
        MockMvcBuilders.standaloneSetup(authController)
            .setControllerAdvice(new GlobalExceptionHandler()) // if you have exception handlers
            .build();
    validReq =
        new RegisterRequestDTO(
            "test@example.com", "Password@123", "John", "919876543210", "address1 2345");
    invalidReq =
        new RegisterRequestDTO(
  ...
  void testRegisterUserAlreadyExists() throws Exception {
    RegisterRequestDTO validRequest =
        new RegisterRequestDTO(
            "existing@example.com", "Password@123", "John Doe", "+919876543210", "123 Street");
